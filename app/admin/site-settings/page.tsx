...
const SECTION_CONFIGS: Record<string, SectionConfig> = {
  ...
  women_categories: {
    title: "Women's Category Cards",
    description: "Circle category cards shown below the hero on the Women's page",
    icon: <Users className="w-5 h-5" />,
    fields: [
      { key: "enabled", label: "Use Custom Categories", type: "text", help: "Set to 'true' to use these cards, or 'false' to auto-generate from products" },
      { key: "cat_1_label", label: "Category 1 - Label", type: "text", placeholder: "Tote" },
      { key: "cat_1_image", label: "Category 1 - Image", type: "image", help: "Square image, shown as circle" },
      { key: "cat_1_link", label: "Category 1 - Link", type: "url", placeholder: "/collections/tote" },
      { key: "cat_2_label", label: "Category 2 - Label", type: "text", placeholder: "Sling" },
      { key: "cat_2_image", label: "Category 2 - Image", type: "image" },
      { key: "cat_2_link", label: "Category 2 - Link", type: "url", placeholder: "/collections/sling" },
      { key: "cat_3_label", label: "Category 3 - Label", type: "text", placeholder: "Clutch" },
      { key: "cat_3_image", label: "Category 3 - Image", type: "image" },
      { key: "cat_3_link", label: "Category 3 - Link", type: "url", placeholder: "/collections/clutch" },
      { key: "cat_4_label", label: "Category 4 - Label", type: "text", placeholder: "Handbag" },
      { key: "cat_4_image", label: "Category 4 - Image", type: "image" },
      { key: "cat_4_link", label: "Category 4 - Link", type: "url", placeholder: "/collections/handbag" },
      { key: "cat_5_label", label: "Category 5 - Label", type: "text", help: "Leave empty to hide" },
      { key: "cat_5_image", label: "Category 5 - Image", type: "image" },
      { key: "cat_5_link", label: "Category 5 - Link", type: "url" },
      { key: "cat_6_label", label: "Category 6 - Label", type: "text", help: "Leave empty to hide" },
      { key: "cat_6_image", label: "Category 6 - Image", type: "image" },
      { key: "cat_6_link", label: "Category 6 - Link", type: "url" },
    ],
  },
  bestsellers: {
