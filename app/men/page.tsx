...
// Filter for SANDESH LAPTOP BAG only - make it unisex
const menProducts = products.filter(product => product.name === "SANDESH LAPTOP BAG");
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm md:text-base text-gray-600">
            Professional laptop bags designed for everyone
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 pb-6 border-b border-gray-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600 ml-2">{menProducts.length} product{menProducts.length !== 1 ? 's' : ''}</span>
          </div>
        </div>
